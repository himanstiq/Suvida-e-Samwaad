      ...
      <div className="grid grid-cols-5 gap-4">
        {LANGUAGES.map(l => (
          <button
            key={l.code}
            onClick={() => setLang(l.code)}
            className={`p-4 rounded-2xl border-2 transition-all kiosk-button flex flex-col items-center gap-1 ${
              lang === l.code 
      ...
      <div className="w-full bg-white p-8 rounded-[2.5rem] shadow-xl border border-slate-100 space-y-8">
        <div className="relative">
          <motion.div 
            ...
            className={`w-full text-center py-6 bg-slate-50 rounded-2xl border-2 transition-colors text-4xl font-mono tracking-widest ${
      ...
      <div className="relative space-y-12">
        ...
        {[
          ...
          <div key={i} className="flex gap-8 items-start relative z-10">
            <div className={`size-14 rounded-full flex items-center justify-center shadow-lg ring-8 ring-white ${
              step.status === 'completed' ? 'bg-india-green text-white' : 
  ...
  return (
    <div className="fixed bottom-24 right-8 flex flex-col items-end gap-4 z-50">
      ...
      <button 
        ...
        className={`size-20 rounded-full flex items-center justify-center text-white shadow-2xl transition-all kiosk-button relative ${
